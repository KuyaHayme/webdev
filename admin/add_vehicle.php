...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $qry = "INSERT INTO `vehicle` (`type`, `name`, `capacity`, `transmission`, `fuel`, `cost`, `image`, `description`) VALUES ('$type', '$name', '$capacity', '$transmission', '$fuel', '$cost', '$image', '$description')";
        ...
        <form id="innerLog" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="transmission" id="transmission-select">
                    <option value="Select Type">Select Transmission</option>
                    <?php
                        include ('connect.php');
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="fuel" id="fuel-select">
                    <option value="Select Type">Select Fuel</option>
                    <?php
                        include ('connect.php');
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="cost">
            </div>
            ...
            <div class="form-group mt-4">
                ...
                <div class="col-md-5">
                    <img class="img-fluid" src="../assets/vehicle/7.png" alt="" id="imgPreview">
                </div>
            </div>
